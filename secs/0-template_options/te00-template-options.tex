...
\def\ZZgraduation{May 2026}

% Title
\def\ZZtitle{On-Board Diagnostics for Diesel Engine Aftertreatment Systems:
             Modelling, System Identification, and Catalyst Aging Detection}
