...
\begin{enumerate}
    ...
    The switched nonlinear model was validated using experimental test-cell data (RMC, Hot-FTP, and Cold-FTP) for both
                ...
                $50\%$, and consistently outperformed the linearized CSTR model from the literature, whose fits were
                typically below $30\%$ on the same data. The results demonstrate that explicitly enforcing conservation
                over the sampling interval and modelling saturation yields a more accurate and physically interpretable
