\begin{abstract}%
        A primary function of diesel engine aftertreatment systems is to eliminate engine-out (EO) NOx through
        ...
        to $NO_x$ sensor cross-sensitivity than the detector based on unsaturated model parameters. The detector's
        performance is validated using both test-cell data and data from four long-haul trucks. Truck data, spanning a
        day, were collected at two different times: first, when the catalyst was degreened (new), and second, when it
        was confirmed to be aged in accordance with existing metrics.
\end{abstract}
