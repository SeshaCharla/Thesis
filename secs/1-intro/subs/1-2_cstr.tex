...
\end{align}
Thus, the system dynamics are conditions on the saturation state of the catalyst. This phenomenon is captured in the model through the following switching function:
\begin{align}
