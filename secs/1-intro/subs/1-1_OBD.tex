...
\begin{enumerate}
        ...
        \item \itbf{Chemical Deposits}: Deposits of sulphur, phosphorus, and urea-related compounds obstruct active
        ...
        \item \itbf{Platinum Deposits}: Trace amounts of volatilized platinum from the diesel oxidation catalyst (DOC)
                ...
                \cite{toops2010deactivation},\cite{jen2009detection}.

        \item \itbf{Catalyst Formulation-Specific Aging} \cite{daya2018development}\cite{daya2020kinetic}: Aging
