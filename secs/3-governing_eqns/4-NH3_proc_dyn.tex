...
Thus, the rate of change of gaseous $NH_3$ on the catalyst surface can be modelled as:
\begin{align*}
...
reactants enters the catalyst chamber. Thus, the molar conservation for the gaseous $NH_3$ process
