...
catalyst chamber reacts with the adsorbed ammonia on the surface and forms $N_2$ and $H_2O$ (Eley-Rideal Mechanism).
...
Thus, the rate of $NO_x$ reduction on the catalyst surface can be modelled as:
\begin{align}
