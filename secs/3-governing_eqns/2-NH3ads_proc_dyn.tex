...
of gaseous ammonia. We first derive the dynamics of the adsorption/desorption process when the catalyst remains unsaturated and the extend it to the saturated case later in Section \ref{sec::sat_cat}.
%===
\begin{align*}
...
\input{./secs/3-governing_eqns/2-1-sig_approx.tex}
