...
A significant challenge posed by low sampling rates is their interaction with the residence time of the reacting flow.
Residence time is defined as the total duration of time that a fluid parcel remains within a control volume, such as the SCR-ASC
...
purpose of this analysis is to demonstrate that the mode of the residence time is substantially lower than the sampling
interval, despite computational inaccuracies.
\begin{align}
        \rho \approx 1.2 \times 10^{-3} \, g/cm^3 \quad \text{at} \quad 250 \lx{^o}{C} \\
