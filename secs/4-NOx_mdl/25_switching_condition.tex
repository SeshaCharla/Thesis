...
\begin{align}
        ...
        & - t_s k_{od}(k-1) \bar \eta_F (k) \notag \\
        & - t_s k_{scr}(k-1) u_1(k-1) \bar \eta_F (k) \label{eqn::unsat_mdl}
\end{align}
...
% =========================================
Incorporating the switching condition and the saturated and unsaturated $NO_x$ reduction dynamics, we have the state diagram for the $NO_x$ reduction dynamics as shown in Figure \ref{fig::no_x_switching}.
