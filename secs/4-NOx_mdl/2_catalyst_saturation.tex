...
catalyst surface concentration, when considering saturation and the zero concentration limit, is
...
Thus, substituting equation \ref{eqn::sigma_elim} into the above equations \ref{eqn::unbounded_sigma_mdl} and \ref{eqn::actual_sigma_mdl}:
%===
\begin{align}
...
%===
Writing the equation (\ref{eqn::eta_max_min}) in terms of the tailpipe $NO_x$ concentration,
\begin{align}
