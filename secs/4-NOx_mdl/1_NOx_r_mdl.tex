...
\begin{enumerate}
        ...
        \item Finally, using (\ref{eqn::nox_avg}), $\sigma(t+t_s)$ and $\sigma(t)$ can be eliminated from
                ...
                on the measured inputs and states alone. Using the discrete-time notation, where $k$ is the index of the 
                sampling period, we get the dynamic model (\ref{eqn::disc_NOx}).
                \begin{align}
