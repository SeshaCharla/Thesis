...
(\cite{daya2018development,daya2020kinetic}). The hypothesis testing framework requires not only the parameter
...
parameter distributions, a detector based on the Wald test (\ref{eqn::wald_statistic}) is proposed to quantify the distance
