...
considered during the RMC tests is between $240\,^\circ\text{C}$ and $360\,^\circ\text{C}$, while for the Hot-FTP tests it is between $200\,^\circ\text{C}$ and $300\,^\circ\text{C}$.
\begin{table}[ht]
        \centering
...
% ==================================================================================================================
\input{secs/5-sat_detect/3_subs/0_necc_cond.tex}
\input{secs/5-sat_detect/3_subs/1_cat_mode.tex}
\input{secs/5-sat_detect/3_subs/2_aging_detection.tex}
