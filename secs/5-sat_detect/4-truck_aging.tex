...
including flow rate, temperature and urea injection rate. The preprocessed data is then partitioned into drive segments
...
Hence, the drive segment data is further pruned to only include segments with at least $150$ samples ($120$ in the case
