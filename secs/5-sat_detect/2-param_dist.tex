...
For a parameter-estimation-based hypothesis test for catalyst saturation and aging detection, both the values of the parameters that minimize the prediction error and their distribution are required. The current section, therefore,
...
\end{align}
%===
In the case of commercial $NO_x$ sensors, the resulting error is modelled as a function of ammonia concentration and a
